    ...
    <div class="container-fluid sticky-top bg-white shadow-sm">
        <div class="container">
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0">
                <a href="self-report.php" class="navbar-brand d-flex align-items-center">
                    <!-- Logo Images -->
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="self-report.php" class="nav-item nav-link active">Tes Mental</a>
    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5" style="max-width: 500px;">
                <h1 class="display-4 border-bottom border-5 custom-border2" style="color: #522e38 !important;">TES MENTAL MANDIRI</h1>
                <p class="m-0" style="color: #522e38 !important;">Geser atau Tekan Tombol Panah untuk Mengganti Form</p>
                <p class="m-0" style="color: #522e38 !important;">(Hasil akan dikirim lewat email masing-masing)</p>
            </div>
            <div class="owl-carousel team-carousel position-relative">
                <div class="team-item">
                    <div class="row g-0 bg-light rounded overflow-hidden" style="background-color: #ffe5ec !important;">
                        <div class="col-12 col-sm-7 h-100 d-flex flex-column">
                            <div class="mt-auto p-4">
                                <h3 style="color: #522e38 !important;">Test 1</h3>
                                <h6 class="fw-bold fst-italic text-primary mb-4" style="color: #ffb3c6 !important;">Cardiology Specialist</h6>
                                <p class="m-0" style="color: #522e38 !important; font-weight: bold;">Dolor lorem eos dolor duo eirmod sea. Dolor sit magna rebum clita rebum dolor</p>
                            </div>
                            <div class="d-flex mt-auto border-top p-4">
                                <a class="btn btn-lg btn-primary rounded-pill custom-button" href="">Go to Google Form</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="team-item">
                    <div class="row g-0 bg-light rounded overflow-hidden" style="background-color: #ffe5ec !important;">
                        <div class="col-12 col-sm-7 h-100 d-flex flex-column">
                            <div class="mt-auto p-4">
                                <h3 style="color: #522e38 !important;">Test 2</h3>
                                <h6 class="fw-bold fst-italic text-primary mb-4" style="color: #ffb3c6 !important;">Cardiology Specialist</h6>
                                <p class="m-0" style="color: #522e38 !important; font-weight: bold;">Dolor lorem eos dolor duo eirmod sea. Dolor sit magna rebum clita rebum dolor</p>
                            </div>
                            <div class="d-flex mt-auto border-top p-4">
                ...
                <div class="team-item">
                    <div class="row g-0 bg-light rounded overflow-hidden" style="background-color: #ffe5ec !important;">
                        <div class="col-12 col-sm-7 h-100 d-flex flex-column">
                            <div class="mt-auto p-4">
                                <h3 style="color: #522e38 !important;">Test 3</h3>
                                <h6 class="fw-bold fst-italic text-primary mb-4" style="color: #ffb3c6 !important;">Cardiology Specialist</h6>
                                <p class="m-0" style="color: #522e38 !important; font-weight: bold;">Dolor lorem eos dolor duo eirmod sea. Dolor sit magna rebum clita rebum dolor</p>
                            </div>
                            <div class="d-flex mt-auto border-top p-4">
